...
export default function HomePage() {
  ...
  // Auto-fill interests from saved preferences when field is empty
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const data: PersistedHomeState = { formData, result, savedActivityIds, savedRecordIds };
        ...
        <div className={styles.formCard}>
          ...
          <form className={styles.form} onSubmit={handleSubmit}>
            <div className={styles.fieldGroup}>
              ...
              <input id="location" name="location" type="text" placeholder="Enter city or area" value={formData.location} onChange={handleChange} />
            </div>
